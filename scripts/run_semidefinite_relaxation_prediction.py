...
if __name__ == '__main__':
    ...
    experiments = ["iris", "ionosphere", "pima_indians", "bank_notes", "mnist"]
    experiments_dirs = ["iris_results", "ionosphere_results", "pima_indians_results", "bank_notes_results", "mnist_results"]
    data_files = ["iris.pkl", "ionosphere.pkl", "pima_indians.pkl", "bank_notes.pkl", "mnist.pkl"]
