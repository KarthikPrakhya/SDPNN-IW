...
def run_cifar10_data_experiment(run_type, add_bias, regularization_parameter, sgd_learning_rate=1e-7, sgd_num_epochs=10000000,
    ...
    formulation of the infinite-width neural network (NN) training problem for the downsampled Cifar10 dataset. As baseline approaches,
    ...
    """
    # Size parameters for the downsampled Cifar10 dataset
    ...
    df_train = pd.read_csv(os.path.join('data', 'cifar10_train_downsampled_pca.csv'),
                     names=['PC1','PC2','PC3','PC4','PC5','PC6','PC7','PC8','PC9','PC10','PC11','PC12','PC13','PC14','PC15','PC16','PC17','PC18','PC19','PC20', 'labels'],
                     header=None)
    df_test = pd.read_csv(os.path.join('data', 'cifar10_test_downsampled_pca.csv'),
                     names=['PC1','PC2','PC3','PC4','PC5','PC6','PC7','PC8','PC9','PC10','PC11','PC12','PC13','PC14','PC15','PC16','PC17','PC18','PC19','PC20', 'labels'],
                     header=None)
    ...
    dataset_path = os.path.join('data', 'cifar10.pkl')
    ...
    if add_bias:
        ...
        dataset = {'train_dataset': train_dataset, 'test_dataset': test_dataset}
        dataset_path = os.path.join('data', 'cifar10_added_bias.pkl')

    # Save the train and test datasets
    with open(dataset_path, 'wb') as handle:
        pkl.dump(dataset, handle, protocol=pkl.HIGHEST_PROTOCOL)

    # Generate the SGD solution for the Cifar10 dataset
    if run_type == 'SGD':
    ...
    # Generate CVX solution for the Cifar10 dataset
    if run_type == 'CVX':
